...
TestObject validatorCounter = new TestObject('validatorCounter')

validatorCounter.addProperty('xpath', ConditionType.EQUALS, xpath)
...
WebUI.verifyElementText(validatorCounter, expectedNumber)
