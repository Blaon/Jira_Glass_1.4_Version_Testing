...
TestObject workflowScreen = new TestObject('screen')

workflowScreen.addProperty('xpath', ConditionType.EQUALS, xpath)
...
WebUI.verifyElementText(workflowScreen, expectedScreen)
