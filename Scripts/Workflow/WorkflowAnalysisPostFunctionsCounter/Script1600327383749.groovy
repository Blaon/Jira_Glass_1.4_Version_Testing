...
TestObject postFunctionCounter = new TestObject('postFunctionCounter')

postFunctionCounter.addProperty('xpath', ConditionType.EQUALS, xpath)
...
WebUI.verifyElementText(postFunctionCounter, expectedNumber)
